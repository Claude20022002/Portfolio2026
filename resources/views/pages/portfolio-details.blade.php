            ...
            <div class="portfolio-details-media">
                ...
                <div class="portfolio-details-slider swiper init-swiper" data-aos="zoom-in">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="{{ asset('img/portfolio/portfolio-5.webp') }}" alt="Portfolio Image" class="img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{ asset('img/portfolio/portfolio-7.webp') }}" alt="Portfolio Image" class="img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{ asset('img/portfolio/portfolio-8.webp') }}" alt="Portfolio Image" class="img-fluid">
                    </div>
                  </div>
              ...
              <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
                <div class="row g-2 mt-3">
                  <div class="col-3">
                    <img src="{{ asset('img/portfolio/portfolio-4.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('img/portfolio/portfolio-6.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('img/portfolio/portfolio-11.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                  <div class="col-3">
                    <img src="{{ asset('img/portfolio/portfolio-12.webp') }}" alt="Gallery Image" class="img-fluid glightbox">
                  </div>
                </div>
              </div>
