...
@section('description', 'Détails du service')
@section('keywords', 'Détails du service')
@section('content')
            ...
            <div class="col-lg-7">
                ...
                <div class="service-hero" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-meta">
                        <span class="service-category">Consulting stratégique</span>
                        <span class="reading-time">5 minutes de lecture</span>
                    </div>
                    <h1>Optimisation des processus d'entreprise</h1>
                    <p class="service-description">
                        L'optimisation des processus d'entreprise est un processus qui permet de rendre les processus
                        d'entreprise plus efficaces et plus rentables.
                        Il permet de réduire les coûts, d'augmenter la productivité et de rendre les processus
                        d'entreprise plus flexibles.
                        Il permet de rendre les processus d'entreprise plus efficaces et plus rentables.
                        Il permet de rendre les processus d'entreprise plus efficaces et plus rentables.
                    </p>
                </div>
                ...
                <div class="service-visual" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('img/services/services-7.webp') }}" alt="Business Process Optimization"
                        class="img-fluid">
                </div>

                <!-- Service Content -->
                <div class="service-narrative" data-aos="fade-up" data-aos-delay="300">
                    <h3>Transformez vos opérations</h3>
                    <p>Donec rutrum congue leo eget malesuada. Vivamus magna justo, lacinia eget consectetur sed,
                        convallis at tellus. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Cras ultricies
                        ligula sed magna dictum porta.</p>

                    <p>Sed porttitor lectus nibh. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui.
                ...
                <div class="timeline-section" data-aos="fade-up" data-aos-delay="500">
                    <h3>Parcours de mise en œuvre</h3>
                    <div class="timeline">
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <h4>Découverte &amp; Évaluation</h4>
                                <p>Comprehensive analysis of current processes and identification of optimization
                                    opportunities.</p>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <p>Development of customized optimization roadmap with clear milestones and success
                                    metrics.</p>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <p>Systematic rollout of process improvements with continuous monitoring and adjustment.
                                </p>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <p>Fine-tuning of implemented solutions and preparation for organization-wide scaling.
                                </p>
                ...
                <div class="service-sidebar" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="success-story">
                        <div class="story-quote">
                            <p>"Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Pellentesque habitant
                                morbi tristique senectus et netus et malesuada fames ac turpis egestas."</p>
                        </div>
                        <div class="story-author">
                            <img src="{{ asset('img/person/person-m-8.webp') }}" alt="Michael Chen"
                                class="author-avatar">
