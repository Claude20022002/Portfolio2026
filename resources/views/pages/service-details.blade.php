        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            ...
            <div class="service-visual" data-aos="zoom-in" data-aos-delay="200">
              <img src="{{ asset('img/services/services-7.webp') }}" alt="Business Process Optimization" class="img-fluid">
            </div>
            ...
            <div class="service-sidebar" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="success-story">
                ...
                <div class="story-author">
                  <img src="{{ asset('img/person/person-m-8.webp') }}" alt="Michael Chen" class="author-avatar">
