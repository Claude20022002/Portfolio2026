        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-strategy">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-1.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-1.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-finance">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-2.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-2.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-operations">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-3.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-3.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-technology">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-4.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-4.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-strategy">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-5.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-5.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-finance">
              <div class="portfolio-card">
                <div class="portfolio-img">
                  <img src="{{ asset('img/portfolio/portfolio-6.webp') }}" alt="Portfolio Item" class="img-fluid">
                  <div class="portfolio-overlay">
                    <a href="{{ asset('img/portfolio/portfolio-6.webp') }}" class="glightbox portfolio-lightbox"><i class="bi bi-plus"></i></a>
                    <a href="#" class="portfolio-details-link"><i class="bi bi-link"></i></a>
                  </div>
                </div>
                <div class="portfolio-info">
